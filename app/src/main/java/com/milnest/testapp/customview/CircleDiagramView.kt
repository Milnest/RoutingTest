...
class CircleDiagramView(context: Context?, attrs: AttributeSet?) : View(context, attrs) {
    val a: TypedArray = context!!.theme.obtainStyledAttributes(attrs, R.styleable.CircleDiagramView, 0, 0)
    var value = a.getFloat(R.styleable.CircleDiagramView_cd_value, 100F)
    var baseColor = a.getColor(R.styleable.CircleDiagramView_cd_base_color, resources.getColor(R.color.colorDarkYellow))
    var baseColorLine = a.getColor(R.styleable.CircleDiagramView_cd_base_color_line, resources.getColor(R.color.colorBlueGray_500))
    var secondColor = a.getColor(R.styleable.CircleDiagramView_cd_second_color, resources.getColor(R.color.colorDarkGreen))
    var secondColorLine = a.getColor(R.styleable.CircleDiagramView_cd_second_color_line, resources.getColor(R.color.colorBlueGray_900))
    var lineColor = a.getColor(R.styleable.CircleDiagramView_cd_line_color, resources.getColor(R.color.colorBlack))
    var textColor = a.getColor(R.styleable.CircleDiagramView_cd_text_color, resources.getColor(R.color.colorBlack))
    var textSize = a.getDimensionPixelSize(R.styleable.CircleDiagramView_cd_text_size, 20)
    var h = a.getDimensionPixelSize(R.styleable.CircleDiagramView_cd_h, 0)
    var rectBig = RectF()
    var rectSmall = RectF()
    var myHeight = height
    var myWidth = width
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        if (myHeight < myWidth) {
            ...
            right = myWidth - paddingEnd.toFloat() - px
